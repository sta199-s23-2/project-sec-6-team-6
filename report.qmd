...
$H_0: \bar x_{public}-\bar x_{private}=0$
difference in mean vaccination rate is 0, there is no significant difference
$H_A: \bar x_{public}-\bar x_{private}\ne0$
difference in mean vaccination rate is not 0, there is a significant difference
