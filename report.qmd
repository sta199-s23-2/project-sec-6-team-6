...
high_low_state_mean |>
  ...
  labs(x = "mmr vaccination rate (%)",
       y = "state",
       title = "States with Highest and Lowest Reported MMR Vaccination Rates")

```

Figure 3. This plot represents the six states with the highest and lowest MMR vaccination rates from the total states sampled. The states with the lowest reported MMR vaccination rates was Arkansas, Washington, and Minnesota. The states with the highest reported MMR vaccination rates was Massachusetts, Illinois, and Pennsylvania.
