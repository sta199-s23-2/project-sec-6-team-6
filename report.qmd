...
Some states do not require schools to report MMR vaccination data, us resulting in a lack of information for a few states. This results in inconclusive data from those states, and they will not be considered for this research analysis.
...
Future work: Our study had a very defined scope. However, future work could include observing vaccination rates in different states or outside of the US. Additionally, testing other variables in anticipation of yielding a stronger predictive model could be another route. 
