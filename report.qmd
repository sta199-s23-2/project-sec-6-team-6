...
We find evidence to reject the null hypothesis and we find strong evidence toward the alternative hypothesis that the vaccination rate in public schools is significantly higher than in private schools.
...
Figure 3.
This graph shows the highest and lowest mmr counties by state. Several states have multiple counties with 100% mmr vaccination rate, but few to none have matching lowest mmrs between counties. If data was not available on the mmr rate of a school, it was removed.
...
>>>>>>> d52415fc359b2c91cc96a2bf74d3c28356037529
