...
-   A well formulated research question. (You may include more than one research question if you want to receive feedback on different ideas for your project. However, one per data set is required.)
    ...
    This question is important because child neglect and abuse is immensely prevalent in the United States, and perhaps understanding in what states this is most common, we could narrow down a solution to diminishing child neglect in America. There really is no target audience, considering that this analysis affects all.
...
proposal2 <- read.csv("https://healthdata.gov/resource/dpz9-kecg.csv")
glimpse(proposal2)
```
